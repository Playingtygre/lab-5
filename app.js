...
function sumArray(testArray){
  ...
  //console.log(sum(sum(testArray[0],testArray[1])[0], testArray[2]));
//   (arraySum);
...
function multiplyArray(testArray){ //eslint-disable-line
  var oneMultiply = multiply(multiply(testArray[0],testArray[1])[0],testArray[2])[0];
  var ouput5 = 'The numbers ' + testArray + ' have a product of ' + oneMultiply + '.';
  return [oneMultiply, ouput5];
}
